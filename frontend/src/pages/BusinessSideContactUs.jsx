        ...
        <div className="w-4/5 p-10">
          ...
          <div className="flex flex-col mt-10 lg:flex-row gap-10">
            <div className="flex flex-col gap-6 w-full lg:w-1/2">
              <button className="group w-3/4 flex items-center justify-between gap-4 bg-white rounded-xl p-4 border text-lg border-blue-600 hover:bg-blue-600 hover:text-white transition duration-300 shadow-md"
...
export default BusinessSideContactUs;
